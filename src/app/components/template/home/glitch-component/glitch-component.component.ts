...
export class GlitchComponentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(window.innerWidth > 500) {
      script.innerHTML = this.scriptWeb;
    } else {
      script.innerHTML = this.scriptMobile;
    }
  ...
  onResize(event: any) {
    ...
    if(window.innerWidth > 500 && this.mobileActive) {
      script.innerHTML = this.scriptWeb;
    } else {
      script.innerHTML = this.scriptMobile;
    }
