...
export class HorizontalTimelineComponent implements AfterViewInit {
  ...
  constructor(private _cdr: ChangeDetectorRef) {
    ...
    this.eventsWrapper = new ElementRef('');
    this.fillingLine = new ElementRef('');
    this.timelineEvents = new QueryList();
  }
  ...
  private _eventsMinDistance: number = 120;
  ...
  setTimelineWidth(elements: TimelineElement[], width: number, eventsMinLapse: number) {
    ...
    let aHref = this.eventsWrapper.nativeElement.querySelectorAll('a')[0];
    console.log(this.eventsWrapper.nativeElement.querySelectorAll('a')[0])
